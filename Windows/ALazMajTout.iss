...
Source: "..\i386-win32\embed\fbclient.dll"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\ib_util.dll"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\icudt30.dll"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\icuin30.dll"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\icuuc30.dll"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\firebird.conf"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\firebird.msg"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\aliases.conf"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\msvcp80.dll"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\msvcr80.dll"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\Microsoft.VC80.CRT.manifest"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\README_embedded.txt"; DestDir: "{tmp}";
Source: "..\i386-win32\embed\intl\fbintl.dll"; DestDir: "{tmp}\intl";
Source: "..\i386-win32\embed\intl\fbintl.conf"; DestDir: "{tmp}\intl";
Source: "..\i386-win32\embed\udf\fbudf.sql"; DestDir: "{tmp}\udf";
Source: "..\i386-win32\embed\udf\ib_udf2.sql"; DestDir: "{tmp}\udf";
Source: "..\i386-win32\embed\udf\fbudf.dll"; DestDir: "{tmp}\udf";
Source: "..\i386-win32\embed\udf\ib_udf.dll"; DestDir: "{tmp}\udf";
Source: "..\i386-win32\embed\isql.exe"; DestDir: "{app}"; Flags : 32bit

;application
Source: "..\i386-win32\Ancestromania.exe"; DestDir: "{app}"; BeforeInstall: BeforeInstallExe; Flags : 32bit 
Source: "..\i386-win32\Ancestromania.ini"; DestDir: "{app}";  Flags : 
Source: "..\i386-win32\Images\*.*"; DestDir: "{app}\Images";
Source: "..\i386-win32\Help\*.*"; DestDir: "{app}\Help";
Source: "..\i386-win32\Tables de references\*.*"; DestDir: "{app}\Tables de references";
Source: "..\i386-win32\AncestroWeb\Classes\Box\*.*"; DestDir: "{app}\AncestroWeb\Classes\Box";
Source: "..\i386-win32\AncestroWeb\Classes\Scripts\*.*"; DestDir: "{app}\AncestroWeb\Classes\Scripts";
Source: "..\i386-win32\AncestroWeb\Classes\PhpMailer\*.*"; DestDir: "{app}\AncestroWeb\Classes\PhpMailer";
Source: "..\i386-win32\AncestroWeb\Classes\PhpMailer\language\*.*"; DestDir: "{app}\AncestroWeb\Classes\PhpMailer\language";
Source: "..\i386-win32\AncestroWeb\Files\default\*.*"; DestDir: "{app}\AncestroWeb\Files\default";
Source: "..\i386-win32\AncestroWeb\Themes\*.*"; DestDir: "{app}\AncestroWeb\Themes";
Source: "..\i386-win32\AncestroWeb\Themes\blue\Css\*.*"; DestDir: "{app}\AncestroWeb\Themes\blue\Css";
Source: "..\i386-win32\AncestroWeb\Themes\blue\Files\*.*"; DestDir: "{app}\AncestroWeb\Themes\blue\Files";
Source: "..\i386-win32\AncestroWeb\Themes\blue\Images\*.*"; DestDir: "{app}\AncestroWeb\Themes\blue\Images";
Source: "..\i386-win32\AncestroWeb\Themes\blue\Images\Map\*.*"; DestDir: "{app}\AncestroWeb\Themes\blue\Images\Map";
Source: "..\i386-win32\AncestroWeb\Themes\blue\Tree\*.*"; DestDir: "{app}\AncestroWeb\Themes\blue\Tree";
Source: "..\i386-win32\AncestroWeb\Themes\default\Css\*.*"; DestDir: "{app}\AncestroWeb\Themes\default\Css";
Source: "..\i386-win32\AncestroWeb\Themes\default\Files\*.*"; DestDir: "{app}\AncestroWeb\Themes\default\Files";
Source: "..\i386-win32\AncestroWeb\Themes\default\Images\*.*"; DestDir: "{app}\AncestroWeb\Themes\default\Images";
...
begin
  ...
  while not ExeOk do
  begin
    PathAppli := GetIniString( 'Path', 'PathAppli', ExpandConstant('{pf}')+'\Ancestromania\', IniFile); 
    if PathAppli > '' then
    begin
...
//  VerBaseActuelle:=IntToStr(VersionLS shr 16)+'.'+IntToStr(VersionLS and $FFFF);
  ...
  if DelIni=true then  //réinitialisation des fenêtres et du menu et du répertoire des scripts
  begin
    DeleteFile ( IniFile );
