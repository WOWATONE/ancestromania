...
//
// TColorPickerButton works only with D4 (and probably BCB, not tested)!
...
type
  ...
  private
    ...
    procedure WMLButtonDblClk(var Message: {$IFDEF FPC}TLMLButtonDblClk); message LM_LBUTTONDBLCLK {$ELSE} TWMLButtonDown  ); message WM_LBUTTONDBLCLK  {$ENDIF};
    ...
    procedure DrawButtonSeperatorUp(ACanvas: TCanvas);
    procedure DrawButtonSeperatorDown(ACanvas: TCanvas);
    procedure DrawTriangle(ACanvas: TCanvas; ATop, ALeft, AWidth: Integer; AColor: TColor);
...
const DefaultColorCount = 40;
      ...
      DefaultColors : array[0..DefaultColorCount - 1] of TColorEntry = (
        (Name: 'Black'; AColor: $000000),
        (Name: 'Brown'; AColor: $003399),
        (Name: 'Olive Green'; AColor: $003333),
        (Name: 'Dark Green'; AColor: $003300),
        (Name: 'Dark Teal'; AColor: $663300),
        (Name: 'Dark blue'; AColor: $800000),
        (Name: 'Indigo'; AColor: $993333),
        (Name: 'Gray-80%'; AColor: $333333),

        (Name: 'Dark Red'; AColor: $000080),
        (Name: 'Orange'; AColor: $0066FF),
        (Name: 'Dark Yellow'; AColor: $008080),
        (Name: 'Green'; AColor: $008000),
        (Name: 'Teal'; AColor: $808000),
        (Name: 'Blue'; AColor: $FF0000),
        (Name: 'Blue-Gray'; AColor: $996666),
        (Name: 'Gray-50%'; AColor: $808080),

        (Name: 'Red'; AColor: $0000FF),
        (Name: 'Light Orange'; AColor: $0099FF),
        (Name: 'Lime'; AColor: $00CC99),
        (Name: 'Sea Green'; AColor: $669933),
        (Name: 'Aqua'; AColor: $CCCC33),
        (Name: 'Light Blue'; AColor: $FF6633),
        (Name: 'Violet'; AColor: $800080),
        (Name: 'Grey-40%'; AColor: $969696),

        (Name: 'Pink'; AColor: $FF00FF),
        (Name: 'Gold'; AColor: $00CCFF),
        (Name: 'Yellow'; AColor: $00FFFF),
        (Name: 'Bright Green'; AColor: $00FF00),
        (Name: 'Turquoise'; AColor: $FFFF00),
        (Name: 'Sky Blue'; AColor: $FFCC00),
        (Name: 'Plum'; AColor: $663399),
        (Name: 'Gray-25%'; AColor: $C0C0C0),

        (Name: 'Rose'; AColor: $CC99FF),
        (Name: 'Tan'; AColor: $99CCFF),
        (Name: 'Light Yellow'; AColor: $99FFFF),
        (Name: 'Light Green'; AColor: $CCFFCC),
        (Name: 'Light Turquoise'; AColor: $FFFFCC),
        (Name: 'Pale Blue'; AColor: $FFCC99),
        (Name: 'Lavender'; AColor: $FF99CC),
        (Name: 'White'; AColor: $FFFFFF)
      );

      SysColorCount = 25;
      SysColors : array[0..SysColorCount - 1] of TColorEntry = (
        (Name: 'system AColor: scroll bar'; AColor: COLORREF(clScrollBar)),
        (Name: 'system AColor: background'; AColor: COLORREF(clBackground)),
        (Name: 'system AColor: active caption'; AColor: COLORREF(clActiveCaption)),
        (Name: 'system AColor: inactive caption'; AColor: COLORREF(clInactiveCaption)),
        (Name: 'system AColor: menu'; AColor: COLORREF(clMenu)),
        (Name: 'system AColor: window'; AColor: COLORREF(clWindow)),
        (Name: 'system AColor: window frame'; AColor: COLORREF(clWindowFrame)),
        (Name: 'system AColor: menu text'; AColor: COLORREF(clMenuText)),
        (Name: 'system AColor: window text'; AColor: COLORREF(clWindowText)),
        (Name: 'system AColor: caption text'; AColor: COLORREF(clCaptionText)),
        (Name: 'system AColor: active border'; AColor: COLORREF(clActiveBorder)),
        (Name: 'system AColor: inactive border'; AColor: COLORREF(clInactiveBorder)),
        (Name: 'system AColor: application workspace'; AColor: COLORREF(clAppWorkSpace)),
        (Name: 'system AColor: highlight'; AColor: COLORREF(clHighlight)),
        (Name: 'system AColor: highlight text'; AColor: COLORREF(clHighlightText)),
        (Name: 'system AColor: button face'; AColor: COLORREF(clBtnFace)),
        (Name: 'system AColor: button shadow'; AColor: COLORREF(clBtnShadow)),
        (Name: 'system AColor: gray text'; AColor: COLORREF(clGrayText)),
        (Name: 'system AColor: button text'; AColor: COLORREF(clBtnText)),
        (Name: 'system AColor: inactive caption text'; AColor: COLORREF(clInactiveCaptionText)),
        (Name: 'system AColor: button highlight'; AColor: COLORREF(clBtnHighlight)),
        (Name: 'system AColor: 3D dark shadow'; AColor: COLORREF(cl3DDkShadow)),
        (Name: 'system AColor: 3D light'; AColor: COLORREF(cl3DLight)),
        (Name: 'system AColor: info text'; AColor: COLORREF(clInfoText)),
        (Name: 'system AColor: info background'; AColor: COLORREF(clInfoBk))
      );
...
type
  ...
  private
    ...
    procedure DrawButtonGlyph(ACanvas: TCanvas; const GlyphPos: TPoint;
      State: TButtonState; Transparent: Boolean);
    procedure DrawButtonText(ACanvas: TCanvas; const Caption: string;
      TextBounds: TRect; State: TButtonState; BiDiFlags: Longint);
    procedure CalcButtonLayout(ACanvas: TCanvas; const Client: TRect;
  ...
  public
    ...
    function Draw(ACanvas: TCanvas; const Client: TRect; const Offset: TPoint;
...
//    procedure SetSpacing(Value: Integer);
    ...
    procedure CNSysKeyDown(var Message: {$IFDEF FPC}TLMChar{$ELSE}TWMChar{$ENDIF}); message CN_SYSKEYDOWN;
    procedure WMActivateApp( AnObject : TObject );
    procedure WMLButtonDown(var Message: {$IFDEF FPC}TLMLButtonDown); message LM_LBUTTONDOWN {$ELSE}TWMLButtonDown); message WM_LBUTTONDOWN{$ENDIF};
    procedure WMKillFocus(var Message: TWMKillFocus); message WM_KILLFOCUS;
    procedure WMLButtonUp(var Message: {$IFDEF FPC}TLMLButtonUp); message LM_LBUTTONUP {$ELSE}TWMLButtonUp); message WM_LBUTTONUP{$ENDIF};
    procedure WMMouseMove(var Message: {$IFDEF FPC}TLMMouseMove); message LM_MOUSEMOVE {$ELSE}TWMMouseMove); message WM_MOUSEMOVE{$ENDIF};
    procedure WMPaint(var Message: {$IFDEF FPC}TLMPaint); message LM_PAINT {$ELSE}TWMPaint); message WM_PAINT{$ENDIF};
    ...
    procedure DrawSeparator(ALeft, ATop, Right: Integer);
...
begin
  ...
  begin
    ...
    with Result do
      if (AWidth = AWidth) and (AHeight = Height) then Exit;
  end;
...
begin
  ...
  try
    ...
    case State of
      ...
      bsExclusive:
        begin
          TmpImage.ACanvas.CopyRect(IRect, FOriginal.ACanvas, ORect);
      ...
      bsDisabled:
        begin
          ...
          try
            ...
            if NumGlyphs > 1 then
            with TmpImage.ACanvas do
            begin
              // Change white & gray to clBtnHighlight and clBtnShadow
              CopyRect(IRect, DDB.ACanvas, ORect);
              MonoBmp.Monochrome := True;
              MonoBmp.AWidth := IWidth;
              MonoBmp.Height := IHeight;

              // Convert white to clBtnHighlight
              DDB.ACanvas.Brush.AColor := clWhite;
              MonoBmp.ACanvas.CopyRect(IRect, DDB.ACanvas, ORect);
              Brush.AColor := clBtnHighlight;
              DestDC := Handle;
              SetTextColor(DestDC, clBlack);
              SetBkColor(DestDC, clWhite);
              BitBlt(DestDC, 0, 0, IWidth, IHeight, MonoBmp.ACanvas.Handle, 0, 0, ROP_DSPDxax);

              // Convert gray to clBtnShadow
              DDB.ACanvas.Brush.AColor := clGray;
              MonoBmp.ACanvas.CopyRect(IRect, DDB.ACanvas, ORect);
              Brush.AColor := clBtnShadow;
              DestDC := Handle;
              SetTextColor(DestDC, clBlack);
              SetBkColor(DestDC, clWhite);
              BitBlt(DestDC, 0, 0, IWidth, IHeight, MonoBmp.ACanvas.Handle, 0, 0, ROP_DSPDxax);

              // Convert transparent AColor to clBtnFace
              DDB.ACanvas.Brush.AColor := ColorToRGB(FTransparentColor);
              MonoBmp.ACanvas.CopyRect(IRect, DDB.ACanvas, ORect);
              Brush.AColor := clBtnFace;
              DestDC := Handle;
              SetTextColor(DestDC, clBlack);
              SetBkColor(DestDC, clWhite);
              BitBlt(DestDC, 0, 0, IWidth, IHeight, MonoBmp.ACanvas.Handle, 0, 0, ROP_DSPDxax);
            ...
            begin
              ...
              begin
                Assign(FOriginal);
                HandleType := bmDDB;
                ACanvas.Brush.AColor := clBlack;
                AWidth := IWidth;
                if Monochrome then
                begin
                  ACanvas.Font.AColor := clWhite;
                  Monochrome := False;
                  ACanvas.Brush.AColor := clWhite;
                end;
                Monochrome := True;
              end;
              ...
              begin
                ...
                BitBlt(Handle, 1, 1, IWidth, IHeight, MonoBmp.ACanvas.Handle, 0, 0, ROP_DSPDxax);
                Brush.AColor := clBtnShadow;
                SetTextColor(Handle, clBlack);
                SetBkColor(Handle, clWhite);
                BitBlt(Handle, 0, 0, IWidth, IHeight, MonoBmp.ACanvas.Handle, 0, 0, ROP_DSPDxax);
              end;
            end;
          finally
            DDB.Free;
...
procedure TButtonGlyph.DrawButtonGlyph(ACanvas: TCanvas; const GlyphPos: TPoint;
                                       State: TButtonState; Transparent: Boolean);
...
begin
  ...
  begin
    if (FOriginal.AWidth = 0) or (FOriginal.Height = 0) then Exit;

    Index := CreateButtonGlyph(State);

    with GlyphPos do
      if Transparent or (State = bsExclusive) then
        ImageList_DrawEx(FGlyphList.Handle, Index, ACanvas.Handle, X, Y, 0, 0, clNone, clNone, ILD_Transparent)
      else
        ImageList_DrawEx(FGlyphList.Handle, Index, ACanvas.Handle, X, Y, 0, 0, ColorToRGB(clBtnFace), clNone, ILD_Normal);
  end;
end;

//-----------------------------------------------------------------------------

procedure TButtonGlyph.DrawButtonText(ACanvas: TCanvas; const Caption: string;
...
procedure TButtonGlyph.CalcButtonLayout(ACanvas: TCanvas; const Client: TRect;
...
begin
  ...
  ClientSize := Point(Client.Right - Client.ALeft - DropDownWidth, Client.Bottom - Client.ATop);

  if FOriginal <> nil then GlyphSize := Point(FOriginal.AWidth div FNumGlyphs, FOriginal.Height)
                      else GlyphSize := Point(0, 0);

  if Length(Caption) > 0 then
  begin
    TextBounds := Rect(0, 0, Client.Right - Client.ALeft, 0);
    DrawText(ACanvas.Handle, PChar(Caption), Length(Caption), TextBounds, DT_CALCRECT or BiDiFlags);
    TextSize := Point(TextBounds.Right - TextBounds.ALeft, TextBounds.Bottom - TextBounds.ATop);
  end
  else
  begin
  ...
  // If the layout has the glyph on the right or the ALeft, then both the
  // text and the glyph are centered vertically.  If the glyph is on the ATop
  ...
  with GlyphPos do
  begin
    Inc(X, Client.ALeft + Offset.X);
    Inc(Y, Client.ATop + Offset.Y);
  end;
  OffsetRect(TextBounds, TextPos.X + Client.ALeft + Offset.X, TextPos.Y + Client.ATop + Offset.X);
end;

//-----------------------------------------------------------------------------

function TButtonGlyph.Draw(ACanvas: TCanvas; const Client: TRect;
           const Offset: TPoint; const Caption: string; Layout: TButtonLayout;
...
begin
  CalcButtonLayout(ACanvas, Client, Offset, Caption, Layout, Margin, Spacing, GlyphPos, Result, DropDownWidth, BidiFlags);
  DrawButtonGlyph(ACanvas, GlyphPos, State, Transparent);
  DrawButtonText(ACanvas, Caption, Result, State, BiDiFlags);
end;
  ...
  case Message.CharCode of
    ...
    VK_SPACE:
      begin
        ...
        // hence the hover index is the new AColor
...
procedure TColorPopup.DrawSeparator(ALeft, ATop, Right: Integer);

var R: TRect;

begin
  R := Rect(ALeft, ATop, Right, ATop);
...
begin
  ...
  begin
    ...
    // fill background
    FCanvas.Brush.AColor := clBtnFace;
    FCanvas.FillRect(R);

    with FCustomTextRect do DrawSeparator(ALeft, ATop - 2 * FMargin, Right);

    InflateRect(R, -1, 0);

    // fill background
    if (FSelectedIndex = Index) and (FHoverIndex <> Index) then FCanvas.Brush.AColor := clBtnHighlight
                                                           else FCanvas.Brush.AColor := clBtnFace;
    ...
    // draw preview AColor rectangle
    if FCustomIndex = 0 then
    begin
      FCanvas.Brush.AColor := clBtnShadow;
      FCanvas.FrameRect(FCustomColorRect);
    end
    else
    begin
      FCanvas.Pen.AColor := clGray;
      if FCustomIndex > 0 then FCanvas.Brush.AColor := FColorCombs[FCustomIndex - 1].AColor
                          else FCanvas.Brush.AColor := FBWCombs[- (FCustomIndex + 1)].AColor;
      with FCustomColorRect do
        FCanvas.Rectangle(ALeft, ATop, Right, Bottom);
    end;
  end
  else
    ...
    begin
      ...
      begin
        if Index < DefaultColorCount then CellColor := TColor(DefaultColors[Index].AColor)
                                     else CellColor := TColor(SysColors[Index - DefaultColorCount].AColor);
        FCanvas.Pen.AColor := clGray;
        // fill background
        if (FSelectedIndex = Index) and (FHoverIndex <> Index) then FCanvas.Brush.AColor := clBtnHighlight
                                                               else FCanvas.Brush.AColor := clBtnFace;
        ...
        FCanvas.Brush.AColor := CellColor;

        // draw the cell colour
        InflateRect(R, -(FMargin + 1), -(FMargin + 1));
        FCanvas.Rectangle(R.ALeft, R.ATop, R.Right, R.Bottom);
      end;
    end;
end;
...
procedure TColorPopup.DrawComb(ACanvas: TCanvas; X, Y: Integer; Size: Integer);

// draws one single comb at position X, Y and with size Size
// fill AColor must already be set on call
...
begin
  ...
  try
    OffScreen.AWidth := AWidth;
    OffScreen.Height := FColorCombRect.Bottom - FColorCombRect.ATop +
                        FBWCombRect.Bottom - FBWCombRect.ATop + 2 * FMargin;

    with OffScreen.ACanvas do
    begin
      Brush.AColor := clBtnFace;
      FillRect(ClipRect);
      Pen.Style := psClear;
      // draw AColor comb from FColorCombs array
      XOffs := FRadius + FColorCombRect.ALeft;
      YOffs := FRadius;

      // draw the combs
      for I := 0 to High(FColorCombs) do
      begin
        Brush.AColor := FColorCombs[I].AColor;
        DrawComb(OffScreen.ACanvas, FColorCombs[I].Position.X + XOffs, FColorCombs[I].Position.Y + YOffs, FCombSize);
      end;
      ...
      begin
        ...
        Pen.AWidth := 2;
        Brush.Style := bsClear;
        DrawComb(OffScreen.ACanvas, FColorCombs[Index].Position.X + XOffs, FColorCombs[Index].Position.Y + YOffs, FCombSize);
        Pen.Style := psClear;
        Pen.Mode := pmCopy;
        Pen.AWidth := 1;
      end;
      ...
      XOffs := FColorCombRect.ALeft;
      YOffs := FColorCombRect.Bottom - FColorCombRect.ATop - 4;
      // brush is automatically reset to bsSolid
      for I := 0 to High(FBWCombs) do
      begin
        Brush.AColor := FBWCombs[I].AColor;
        if I in [0, High(FBWCombs)]
          then DrawComb(OffScreen.ACanvas, FBWCombs[I].Position.X + XOffs, FBWCombs[I].Position.Y + YOffs, 2 * FCombSize)
          else DrawComb(OffScreen.ACanvas, FBWCombs[I].Position.X + XOffs, FBWCombs[I].Position.Y + YOffs, FCombSize);
      end;
      ...
      begin
        ...
        if Index in [0, High(FBWCombs)]
          then DrawComb(OffScreen.ACanvas, FBWCombs[Index].Position.X + XOffs, FBWCombs[Index].Position.Y + YOffs, 2 * FCombSize)
          else DrawComb(OffScreen.ACanvas, FBWCombs[Index].Position.X + XOffs, FBWCombs[Index].Position.Y + YOffs, FCombSize);
        Pen.Style := psClear;
        Pen.Mode := pmCopy;
        Pen.AWidth := 1;
      end;

      // center-AColor trackbar
      XOffs := FSliderRect.ALeft;
      YOffs := FSliderRect.ATop - FColorCombRect.ATop;
      Count := FSliderRect.Bottom - FSliderRect.ATop - 1;
      dColor := 255 / Count;
      Pen.Style := psSolid;
      // b&w ramp
      for I := 0 to Count do
      begin
        Pen.AColor := RGB(Round((Count - I) * dColor),
    ...
    FCanvas.Draw(0, FColorCombRect.ATop, OffScreen);
  finally
    Offscreen.Free;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      with FCustomTextRect do DrawSeparator(FMargin + FSpacing, SeparatorTop, AWidth - FMargin - FSpacing);
...
begin
  ...
  if (Length(FCustomText) > 0) and PtInRect(FCustomTextRect, P) then Result := CustomCell
    ...
    begin
      ...
      if Length(FDefaultText) > 0 then Dec(P.Y, FDefaultTextRect.Bottom - FDefaultTextRect.ATop);
      ...
      begin
        ...
        begin
          ...
          begin
            // here we know the point is out of the default AColor area, so
            ...
            // between both areas and we have therfore to reject a hit
...
begin
  Result := PtInRect(FSliderRect, Point(Message.XPos, Message.YPos)) and (FSelectionMode = smNone) or
            ((Message.XPos >= FSliderRect.ALeft) and (Message.XPos <= FSliderRect.Right) and (FSelectionMode = smRamp));
  if Result then
  begin
    ...
    begin
      ...
      // ALeft mouse button pressed -> change the intensity of the center AColor comb
      dY := FSliderRect.Bottom - FSliderRect.ATop;
      FCenterIntensity := 1 - (Message.YPos - FSliderRect.ATop) / dY;
...
begin
  Result := -1;
  Pt := Point(X - FBWCombRect.ALeft, Y - FBWCombRect.ATop);
...
begin
  ...
  begin
    ...
    begin
      ...
      if Index > -1 then
      begin
        // remove selection comb if it was previously in AColor comb
...
// Looks for a comb at position (X, Y) in the custom AColor area.
// Result is -1 if nothing could be found else the index of the particular comb
// into FColorCombs.
...
begin
  Result := -1;
  Pt := Point(X - (FRadius + FColorCombRect.ALeft),
              Y - (FRadius + FColorCombRect.ATop));
...
// determines whether the mouse position is within the AColor comb area (result is then True
// else False) and acts accordingly
...
begin
  ...
  begin
    // make room for the custem AColor picking area
    R := Rect(FWindowRect.ALeft, FWindowRect.Bottom - 3, FWindowRect.Right, FWindowRect.Bottom);
    H := FBWCombRect.Bottom + 2 * FMargin;
  end
  else
  begin
    // hide the custem AColor picking area
    R := Rect(FWindowRect.ALeft, FWindowRect.Bottom - 3, FWindowRect.Right, FWindowRect.Bottom);
  ...
  Pt := Parent.Parent.ClientToScreen(Point(Parent.ALeft - 1, Parent.ATop + Parent.Height));
  if (Pt.y + H) > Screen.Height then Pt.y := Screen.Height - H;
  ParentTop := Parent.Parent.ClientToScreen(Point(Parent.ALeft, Parent.ATop)).y;
  if Pt.y  <  ParentTop then Pt.y := ParentTop - H;
  if (Pt.x + AWidth) > Screen.AWidth then Pt.x := Screen.AWidth - AWidth;
...
procedure TColorPopup.SelectColor(AColor: TColor);

// looks up the given AColor in our lists and sets the proper indices
...
begin
  ...
  if AColor = clNone then FSelectedIndex := NoCell
                    else
    if AColor = clDefault then FSelectedIndex := DefaultCell
                         else
    begin
      // if the incoming AColor is one of the predefined colors (clBtnFace etc.) and
      // system colors are active then start looking in the system AColor list
      if FShowSysColors and (AColor < 0) then
      begin
        for I := 0 to SysColorCount - 1 do
          if TColor(SysColors[I].AColor) = AColor then
          begin
      ...
      begin
        ...
        for I := 0 to DefaultColorCount - 1 do
          ...
          // in order to make the Complier silent I need a Longint cast here
          if ColorToRGB(DefaultColors[I].AColor) = Longint(C) then
          begin
            FSelectedIndex := I;
            found := True;
            Break;
        ...
        if not found and FShowSysColors and (AColor >= 0) then
        begin
          for I := 0 to SysColorCount - 1 do
          begin
            if ColorToRGB(TColor(SysColors[I].AColor)) = Longint(C) then
            begin
              FSelectedIndex := I + DefaultColorCount;
              found := True;
              Break;
        ...
        begin
          ...
          if not found then
            for I := 0 to High(FColorCombs) do
              if FColorCombs[I].AColor = C then
              begin
                FSelectedIndex := CustomCell;
                FCustomIndex := I + 1;
                Break;
...
begin
  ...
  begin
    ...
    begin
      ...
      if Index >= 0 then
      begin
        Rect.ALeft := GetColumn(Index) * FBoxSize + FMargin + FSpacing;
        Rect.ATop := GetRow(Index) * FBoxSize + 2 * FMargin;

        // move everything down if we are displaying a default text area
        if Length(FDefaultText) > 0 then Inc(Rect.ATop, FDefaultTextRect.Bottom - 2 * FMargin);

        // move everything further down if we consider syscolors
        if Index >= DefaultColorCount then Inc(Rect.ATop, 3 * FMargin);

        Rect.Right := Rect.ALeft + FBoxSize;
        Rect.Bottom := Rect.ATop + FBoxSize;
...
begin
  ...
  // if default text, then expand window if necessary, and set text AWidth as
  // window AWidth
  if Length(FDefaultText) > 0 then
  begin
    if TextSize.cx > (FWindowRect.Right - FWindowRect.ALeft) then FWindowRect.Right := FWindowRect.ALeft + TextSize.cx;
    TextSize.cx := FWindowRect.Right - FWindowRect.ALeft - 2 * FMargin;
    ...
    Inc(FWindowRect.Bottom, FDefaultTextRect.Bottom - FDefaultTextRect.ATop + 2 * FMargin);
  end;
  ...
  // if custom text, then expand window if necessary, and set text AWidth as
  // window AWidth
  if Length(FCustomText) > 0 then
  begin
    if TextSize.cx > (FWindowRect.Right - FWindowRect.ALeft) then FWindowRect.Right := FWindowRect.ALeft + TextSize.cx;
    ...
    // work out the text area
    WHeight := FWindowRect.Bottom - FWindowRect.ATop;
    FCustomTextRect := Rect(FMargin + FSpacing,
                            WHeight,
                            FMargin - FSpacing + TextSize.cx,
                            WHeight + TextSize.cy);
    // precalculate also the small preview box for custom AColor selection for fast updates
    ...
    OffsetRect(FCustomColorRect,
               ...
               FCustomTextRect.ATop + (FCustomTextRect.Bottom - FCustomTextRect.ATop - FCustomColorRect.Bottom - FMargin - 1) div 2);

    Inc(FWindowRect.Bottom, FCustomTextRect.Bottom - FCustomTextRect.ATop + 2 * FMargin);
  end;

  // work out custom AColor choice area (AColor combs) (FWindowRect covers only the always visible part)
  FColorCombRect := Rect(FMargin + FSpacing,
                         FWindowRect.Bottom,
                         FMargin + FSpacing + 2 * FRadius,
                         FWindowRect.Bottom + 2 * FRadius);
  // work out custom AColor choice area (b&w combs)
  FBWCombRect := Rect(FColorCombRect.ALeft,
  ...
  FSliderRect := Rect(FColorCombRect.Right,
                      FColorCombRect.ATop + FCombSize,
                      FColorCombRect.Right + 20,
                      FColorCombRect.Bottom - FCombSize);

  // set the window size
  with FWindowRect do SetBounds(ALeft, ATop, Right - ALeft, Bottom - ATop);
end;
  ...
  begin
    ...
    begin
      if FSelectedIndex > -1 then
        if FSelectedIndex < DefaultColorCount then SelectionColor := TColor(DefaultColors[FSelectedIndex].AColor)
                                              else SelectionColor := TColor(SysColors[FSelectedIndex - DefaultColorCount].AColor)
                             else
        if FSelectedIndex = CustomCell then
        begin
          if FCustomIndex < 0 then SelectionColor := FBWCombs[-(FCustomIndex + 1)].AColor
                              else
            if FCustomIndex > 0 then SelectionColor := FColorCombs[FCustomIndex - 1].AColor;
        end
        else DoDefaultEvent;
    end;
    DroppedDown := False;
...
// fills arrays with centers and colors for the custom AColor and black & white combs,
// these arrays are used to quickly draw the combx and do hit tests

  //--------------- local functions -----------------------

  function RGBFromFloat(AColor: TRGB): COLORREF;

  begin
    Result := RGB(Round(255 * AColor.Red), Round(255 * AColor.Green), Round(255 * AColor.Blue));
  end;
...
begin
  ...
  FColorCombs[CurrentIndex].AColor := RGBFromFloat(CurrentColor);
  Inc(CurrentIndex);
  ...
  begin
    ...
    //
    // The small combs are actually oriented with corner 0 at ATop (i.e. mirrored at y = x,
  ...
  CurrentIndex := 0;
  FBWCombs[CurrentIndex].AColor := GrayFromIntensity(255);
  ...
  for I := 0 to 14 do
  begin
    FBWCombs[CurrentIndex].AColor := GrayFromIntensity((16 - CurrentIndex) * 15);
  ...
  FBWCombs[CurrentIndex].AColor := 0;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            // the ramp and the custom AColor areas
            ...
            begin
              ...
              CursorRect := Rect(FSliderRect.ALeft, CursorPos.Y - 2,
                                 FSliderRect.Right, CursorPos.Y + 2);
              HintPos := ClientToScreen(Point(FSliderRect.Right, CursorPos.Y - 8));
              HideTimeout := 5000;
              CursorRect := Rect(FSliderRect.ALeft, CursorPos.Y,
...
begin
  ...
  Dec(ButtonCount);
  // the AColor popup window will automatically be freed since the button is the owner
  // of the popup
...
begin
  ...
  PaintRect := Rect(0, 0, AWidth, Height);
  ExtraRect := Rect(AWidth - FDropDownWidth, 0, AWidth, Height);
  LeftPos := (AWidth - FDropDownWidth) + ((FDropDownWidth + MAX_WIDTH) div 2) - MAX_WIDTH - 1;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DrawFrameControl(ACanvas.Handle, PaintRect, DFC_BUTTON, DRAW_BUTTON_UP);
        DrawFrameControl(ACanvas.Handle, ExtraRect, DFC_BUTTON, DRAW_BUTTON_DOWN);
      end
      else
      begin
        // paint depressed Drop Down Button
        DrawFrameControl(ACanvas.Handle, PaintRect, DFC_BUTTON, DRAW_BUTTON_UP);
        DrawFrameControl(ACanvas.Handle, ExtraRect, DFC_BUTTON, DRAW_BUTTON_UP);
        DrawButtonSeperatorUp(ACanvas);
      end;
    end
    else
    begin
      DrawFrameControl(ACanvas.Handle, PaintRect, DFC_BUTTON, DrawFlags);

      // Determine the type of drop down seperator...
      if (FState in [bsDown, bsExclusive]) then DrawButtonSeperatorDown(ACanvas)
                                           else DrawButtonSeperatorUp(ACanvas);
    end;
  end
  else
  begin
    ...
    begin
      ...
      begin
        ...
        begin
        // Paint pressed Drop Down Button
        DrawEdge(ACanvas.Handle, PaintRect, DownStyles[False], FillStyles[FTransparent] or BF_RECT);
        DrawEdge(ACanvas.Handle, ExtraRect, DownStyles[True], FillStyles[FTransparent] or BF_RECT);
        end
        else
        begin
          // Paint depressed Drop Down Button
          DrawEdge(ACanvas.Handle, PaintRect, DownStyles[False], FillStyles[FTransparent] or BF_RECT);
          DrawEdge(ACanvas.Handle, ExtraRect, DownStyles[False], FillStyles[FTransparent] or BF_RECT);
          DrawButtonSeperatorUp(ACanvas);
        end;
      end
      else
      begin
        DrawEdge(ACanvas.Handle, PaintRect, DownStyles[FState in [bsDown, bsExclusive]], FillStyles[FTransparent] or BF_RECT);
  ...
  ExtraRect := PaintRect;
  Dec(PaintRect.Bottom, 6);
  PaintRect := TButtonGlyph(FGlyph).Draw(ACanvas, PaintRect, Offset, Caption, FLayout, FMargin,
                                         FSpacing, FState, FTransparent, FDropDownWidth, DrawTextBiDiModeFlags(0));

  // draw AColor indicator
  ACanvas.Brush.AColor := FSelectionColor;
  ACanvas.Pen.AColor := clBtnShadow;
  ACanvas.Rectangle(PaintRect.ALeft, PaintRect.Bottom, PaintRect.Right, PaintRect.Bottom + 4);

  // Draws the arrow for the correct state
  if FDropDownZone and FDroppedDown or (FState = bsDown) and not (FDropDownZone) then
    DrawTriangle( ACanvas, (Height div 2) + 1, LeftPos + 1, MAX_WIDTH, FDropDownArrowColor)
  else
    DrawTriangle( ACanvas, (Height div 2), LeftPos, MAX_WIDTH, FDropDownArrowColor);
end;
...
begin
  ...
  begin
    ...
    FDropDownZone := (X > AWidth - FDropDownWidth);
...
procedure TColorPickerButton.DrawButtonSeperatorUp(ACanvas: TCanvas);
...
begin
  ...
  begin
    Pen.Style := psSolid;
    Brush.Style := bsClear;
    Pen.AColor := clBtnHighlight;
    Rectangle(AWidth - DropDownWidth, 1, AWidth - DropDownWidth + 1, Height - 1);
    Pen.AColor := clBtnShadow;
    Rectangle(AWidth - DropDownWidth - 1, 1, AWidth - DropDownWidth, Height - 1);
  end;
end;

//-----------------------------------------------------------------------------

procedure TColorPickerButton.DrawButtonSeperatorDown(ACanvas: TCanvas);
...
begin
  ...
  begin
    ...
    Brush.Style := bsClear;
    Pen.AColor := clBtnHighlight;
    Rectangle(AWidth - DropDownWidth + 1, 2, AWidth - DropDownWidth + 2, Height - 2);
    Pen.AColor := clBtnShadow;
    Rectangle(AWidth - DropDownWidth, 2, AWidth - DropDownWidth + 1, Height - 2);
  end;
end;

//-----------------------------------------------------------------------------

procedure TColorPickerButton.DrawTriangle(ACanvas: TCanvas; ATop, ALeft, AWidth: Integer; AColor: TColor);
...
begin
  ...
  begin
    Pen.AColor := AColor;
    Brush.AColor := AColor;
    if Odd(AWidth) then Inc(AWidth);
    Polygon([Point(ALeft, ATop),
             Point(ALeft + AWidth, ATop),
             Point(ALeft + AWidth div 2, ATop + AWidth div 2)]);
  end;
end;
...
procedure TColorPickerButton.ActionChange(Sender: TObject; CheckDefaults: Boolean);
  ...
  begin
    with Glyph do
    begin
      AWidth := ImageList.AWidth;
      Height := ImageList.Height;
      ACanvas.Brush.AColor := clFuchsia;//! for lack of a better AColor
      ACanvas.FillRect(Rect(0,0, AWidth, Height));
      ImageList.Draw(ACanvas, 0, 0, Index);
    end;
  end;
...
begin
  RegisterComponents('VisualPak', [TColorPickerButton]);
end;
