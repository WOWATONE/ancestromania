...
sudo chown -R root Update_AncestroIntel64.tar
sudo tar -czvf Update_AncestroIntel64.tar.gz Update_AncestroIntel64.tar
sudo chown -R matthieu Update_AncestroIntel64.tar
