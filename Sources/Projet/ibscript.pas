...
begin
  ...
  if (Token = 'INSERT') or (Token = 'DELETE') or   {do not localize}
    ...
    ((Token = 'EXECUTE') and (Token1 = 'PROCEDURE')) then  {do not localize} //? inutille déjà satisfait par le précédent test Token='EXECUTE'
    Result := stmtDML
  else
...
procedure TIBSQLParser.RemoveComment; //AL2012 ajout élimination lignes --
var
